...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/ideas'); // proxy will redirect to onboarding if needed
      router.refresh();
    } catch (err: any) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    await signIn('google', { callbackUrl: '/ideas' });
  };
    ...
    <div className="flex min-h-screen items-center justify-center p-4 bg-bg-subtle">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-fg">Ventiq</h1>
        ...
        <Card className="p-8 shadow-lg">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-fg-muted">Or continue with</span>
            </div>
          </div>
