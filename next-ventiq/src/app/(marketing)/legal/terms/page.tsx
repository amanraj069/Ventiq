      ...
      <section className="pb-32">
        <div className="max-w-3xl mx-auto px-6">
          <div className="space-y-12 text-fg-muted leading-relaxed text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">2. Description of Service</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">3. User Accounts</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">4. Intellectual Property</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">5. AI Evaluation Disclaimer</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">6. Investor Verification</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">7. Prohibited Conduct</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">8. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-fg mb-4">9. Contact</h2>
              <p>For questions about these Terms, contact us at <span className="text-fg font-medium">legal@ventiq.ai</span>.</p>
            </section>
          </div>
        </div>
      </section>
