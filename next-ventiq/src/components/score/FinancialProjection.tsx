...
export function FinancialProjection({ financialProjection }: FinancialProjectionProps) {
 ...
 <p className="text-fg-muted text-sm leading-relaxed mb-5">{financialProjection.summary}</p>
 ...
 <div className="text-[11px] text-fg-faint uppercase tracking-wider font-medium">{metric.label}</div>
 </div>
 ))}
 </div>
 </div>
